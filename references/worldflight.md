...
<div data-sc-mode="worldflight" data-sc-seam="0.12">
  ...
  <div data-sc-world>
    <div data-sc-segment data-sc-w="0.95" data-sc-linger="0.3"
      ...
      <img class="sc-world__poster" src="assets/p1-v01.webp" alt="" decoding="async">
      <video data-sc-src="assets/leg1-v01.mp4"
             data-sc-src-mobile="assets/leg1-mobile-v01.mp4"></video>
    </div>
    <div data-sc-segment data-sc-w="0.9" data-sc-linger="0.42"
         data-sc-waypoint="Thermocline">
      <img class="sc-world__poster" src="assets/p2-v01.webp" alt="" decoding="async">
      <video data-sc-src="assets/leg2-v01.mp4"
             data-sc-src-mobile="assets/leg2-mobile-v01.mp4"></video>
    </div>
...
node "<skill>/scripts/ffmpeg.mjs" -n -sseof -0.15 -i legN-v01.mp4 -frames:v 1 -q:v 2 chainN-v01.png
# first frame of a leg, for its poster
node "<skill>/scripts/ffmpeg.mjs" -n -i legN-v01.mp4 -frames:v 1 -q:v 3 pN-v01.webp
```
...
```bash
# Run from the build folder. Keep the server in a managed terminal session.
node "<skill>/scripts/serve.mjs" --root . --port 45XX
# Run these from another terminal session, then stop the server session.
node "<skill>/scripts/shoot.mjs" --url http://localhost:45XX --out lab/<name>-shots --per-act 8
node "<skill>/scripts/shoot.mjs" --url http://localhost:45XX --out lab/<name>-reduced --reduced-motion
```
