...
#
#   ./encode.sh in-v01.mp4 out-v01.mp4            desktop master  (1080p, -g 8, crf 20)
#   ./encode.sh in-v01.mp4 out-mobile-v01.mp4 mobile   phone variant   (720p,  -g 4, crf 24)
#
...
#
#   ./encode.sh in-v01.mp4 out-v01.mp4 desktop 23        fourth positional argument
#   SCROLLCRAFT_CRF=23 ./encode.sh in-v01.mp4 out-v01.mp4    or the env var
#
...
mkdir -p "$(dirname "$OUT")"
[ ! -e "$OUT" ] || { echo "ERROR: output already exists; choose a versioned filename: $OUT" >&2; exit 1; }

"$FFMPEG" -n -hide_banner -loglevel error -i "$IN" \
  -an \
